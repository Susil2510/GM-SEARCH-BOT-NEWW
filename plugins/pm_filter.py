    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('📌 Rᴇǫᴜᴇꜱᴛ Hᴇʀᴇ', url ='https://t.me/GM_MOVIE_REQUEST')]]))
    ...
    try:
        ...
        if settings['max_btn']:
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("📄 𝗣𝗮𝗴𝗲", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/10)+1} / {math.ceil(total/10)}", callback_data="pages"), InlineKeyboardButton("NEXT ⏩", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("📄 𝗣𝗮𝗴𝗲", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/int(MAX_B_TN))+1} / {math.ceil(total/int(MAX_B_TN))}", callback_data="pages"), InlineKeyboardButton("NEXT ⏩", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
                        InlineKeyboardButton("⏪ BACK​", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('✧ 𝙲𝙾𝙽𝚃𝙰𝙲𝚃​', url='t.me/Srikanth_Official_Bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="● ◌ ◌"
        ...
        buttons = [[
            InlineKeyboardButton('𝙲𝙾𝙽𝚃𝙰𝙲𝚃', url='https://t.me/Srikanth_Official_Bot')
        ],[
            InlineKeyboardButton('👩‍🦯 𝙱𝙰𝙲𝙺', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('🎁 𝙼𝙾𝚁𝙴 𝙵𝙴𝙰𝚃𝚄𝚁𝙴𝚂 🎁', callback_data='help2')  
        ], [
            ...
            InlineKeyboardButton('📝 𝚁𝚄𝙻𝙴𝚂', callback_data='rule_btn'),
            InlineKeyboardButton('⚙️ 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂', callback_data='setting_btn')
        ], [
        ...
        buttons = [[                               
            ...
            InlineKeyboardButton('𝙶𝙴𝙽-𝙿𝙰𝚂𝚂​', callback_data='gen_pass')
            ],[
            ...
            InlineKeyboardButton('𝚂𝚃𝙸𝙲𝙺-𝙸𝙳', callback_data='sticker'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        try:
            ...
            if settings['max_btn']:
                btn.append(
                    [InlineKeyboardButton("📄 𝗣𝗮𝗴𝗲​", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/10)}",callback_data="pages"), InlineKeyboardButton(text="NEXT ⏩",callback_data=f"next_{req}_{key}_{offset}")]
                )
            else:
                btn.append(
                    [InlineKeyboardButton("📄 𝗣𝗮𝗴𝗲​", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/int(MAX_B_TN))}",callback_data="pages"), InlineKeyboardButton(text="NEXT ⏩",callback_data=f"next_{req}_{key}_{offset}")]
                )
        except KeyError:

class script(object):
    START_TXT = """𝙷𝙴𝙻𝙻𝙾 <b>{}</b> ❤️
    
𝙸 𝙰𝙼 𝙰 𝙿𝙾𝚆𝙴𝚁𝙵𝚄𝙻 𝙼𝙾𝚅𝙸𝙴𝚂 𝚂𝙴𝙰𝚁𝙲𝙷 𝙱𝙾𝚃. 𝚈𝙾𝚄 𝙲𝙰𝙽 𝚄𝚂𝙴 𝙼𝙴 𝙸𝙽 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙸 𝚆𝙸𝙻𝙻 𝙶𝙸𝚅𝙴 𝙼𝙾𝚅𝙸𝙴𝚂 𝙸𝙽 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙿𝙼 !!  

𝙸𝚃 𝙸𝚂 𝙴𝙰𝚂𝚈 𝚃𝙾 𝚄𝚂𝙴 𝙼𝙴, 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽"""

    
    STARTER_TXT = """𝙷𝙴𝙻𝙻𝙾 <b>{}</b> ❤️

𝚃𝙷𝙸𝚂 𝙸𝚂 𝙰 𝙿𝚁𝙾 𝙼𝙾𝚅𝙸𝙴𝚂 𝚂𝙴𝙰𝚁𝙲𝙷 𝙱𝙾𝚃.

𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽.."""
...
✯ 𝙰𝙳𝙼𝙸𝙽 : <a href=https://t.me/Srikanth_Official_Bot>𝗠𝗥.𝗦𝗥𝗜𝗞𝗔𝗡𝗧𝗛</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 : 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴 : 𝙼𝙾𝙽𝙶𝙾-𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁 : 𝙰𝙽𝚈𝚆𝙷𝙴𝚁𝙴
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/Geetha_Movies)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """<i><b>I couldn't find anything related to that. \nDid you mean any one of these?</i></b>"""
...
<b>• ꜰᴜʟʟ ɴᴀᴍᴇ : Mr.Srikanth</b> 
<b>• ᴜꜱᴇʀɴᴀᴍᴇ : @Srikanth_Official_Bot</b>
"""
    NORSLTS = """
★ #𝗡𝗼𝗥𝗲𝘀𝘂𝗹𝘁𝘀 ★
...
நகல் எழுதப்பட்டால், கோப்பு 05 நிமிடங்களில் நீக்கப்படும்"""
    ...
    NOR_TXT = """
⚡Baby, Here is what i found for your query <b>{}</b>"""
    
    SUPPORT_INFO = """<b>
🔋 ᴄʜᴀɴɴᴇʟs & ɢʀᴏᴜᴘs ᴍᴏᴅᴜʟᴇ 🔋

ᴄᴏᴍᴘʟᴇᴛᴇ ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛɪɴɢ ɢʀᴏᴜᴘ.
ᴀʟʟ ʟᴀɴɢᴜᴀɢᴇs ᴍᴏᴠɪᴇs & ꜱᴇʀɪᴇs.</b>"""
...
ɴᴏᴛᴇ : ᴜsᴇ ᴍx ᴘʟᴀʏᴇʀ ғᴏʀ ᴀᴜᴅɪᴏ ᴄʜᴀɴɢᴇ ᴏᴘᴛɪᴏɴ</b>"""
